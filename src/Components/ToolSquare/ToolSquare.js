    ...
    return (
        <div className="ToolSquare">
            {type === "lenguage" ? <div style={{ backgroundColor: `${color}` }} className="ToolSquare-container">
                <img alt={`${imageStats}`} style={{ width: `${imageWidth}`, height: `${imageHeight}` }} className="ToolSquare-container_image" src={`${imageStats}`} />
                ...
                <div style={{ backgroundColor: `${color}` }} className="ToolSquare-containerBig">
                    <img alt={`${imageStats}`} style={{ width: `${imageWidth}`, height: `${imageHeight}` }} className="ToolSquare-containerBig_image" src={imageStats} />
